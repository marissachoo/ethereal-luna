...
export default class RecipientDetailScreen extends Component {
  state = {
    name: "",
    phone: "",
    address: "",
  ...
  render() {
    ...
    return (
      <ScrollView>
        ...
        <Ionicons onPress={this.deleteItem(key)} name="md-trash" size={32} color="#141414" style={{marginTop: 5, marginHorizontal: 10}} />
      </ScrollView>
    );
  }
...
RecipientDetailScreen.navigationOptions = {
